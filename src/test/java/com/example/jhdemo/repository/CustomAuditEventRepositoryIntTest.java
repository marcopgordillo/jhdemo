...
import com.example.jhdemo.config.audit.AuditEventConverter;
import com.example.jhdemo.domain.PersistentAuditEvent;
...
import static com.example.jhdemo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
