...
describe('Service Tests', () => {
    ...
    describe('Garantia Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GarantiaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/garantias/' + 123);
            });
            it('should return Garantia', () => {

                let entity: Garantia;
                service.find(123).subscribe((_entity: Garantia) => {
                    entity = _entity;
                });
