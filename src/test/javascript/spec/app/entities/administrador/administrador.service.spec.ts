...
describe('Service Tests', () => {
    ...
    describe('Administrador Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AdministradorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/administradors/' + 123);
            });
            it('should return Administrador', () => {

                let entity: Administrador;
                service.find(123).subscribe((_entity: Administrador) => {
                    entity = _entity;
                });
