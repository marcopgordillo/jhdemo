...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/garantia'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Garantia) {
        return item.id;
    }
    ...
    registerChangeInGarantias() {
        this.eventSubscriber = this.eventManager.subscribe('garantiaListModification', (response) => this.loadAll());
    }
