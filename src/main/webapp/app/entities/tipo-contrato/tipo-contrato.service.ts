...
export class TipoContratoService {
    ...
    find(id: number): Observable<TipoContrato> {
     ...
     */
    private convertItemFromServer(json: any): TipoContrato {
        const entity: TipoContrato = Object.assign(new TipoContrato(), json);
        return entity;
    }
