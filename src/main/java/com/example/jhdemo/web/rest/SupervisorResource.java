...
public class SupervisorResource {
    ...
    @Timed
    public ResponseEntity<List<Supervisor>> getAllSupervisors(Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<Supervisor>> searchSupervisors(@RequestParam String query, Pageable pageable) {
